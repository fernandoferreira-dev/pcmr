          ...
          >
            {isEditing ? (
              <input
                ...
                onChange={(e) =>
                  handleInputChange("telemovel", e.target.value || null)
                }
              />
            ) : (
              <span className="text-lg font-semibold text-gray-800">
                ...
                <input
                  ...
                  value={
                    editForm?.dataNascimento
                      ? editForm.dataNascimento.split("T")[0]
                      : ""
                  }
                  onChange={(e) =>
                    handleInputChange("dataNascimento", e.target.value || null)
                  }
                />
              ) : (
